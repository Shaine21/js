class level_03_game extends Phaser.Scene {
   ...
   this.cameras.main.setBounds(0, 0, this.level_03_game.widthInPixels, this.level_03_game.heightInPixels);
    ...
    this.time.addEvent({
      ...
      this.physics.add.overlap(this.bullet, [this.enemy1, this.enemy2,this.enemy3, this.enemy4,this.enemy5, this.enemy6,this.enemy7, this.enemy8], globalKillEnemies, null, this);
    ...
    update() {
      ...
      this.jumpSnd.play()    
          ...
          if (
            this.player.x > 6337.55 && window.key>3
          ) {
            console.log("Go to level 4 function");
            window.heart=3
            this.level_04_game();
          }
  ...
  level_04_game(player, tile) {
    console.log("level_04_game function");
    this.scene.start("level_04_game", {
      player: player,

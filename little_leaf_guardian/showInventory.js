class showInventory extends Phaser.Scene {
   ...
   create () {
       ...
       this.key = this.add.image (520, 50, 'samplingIMG').setScrollFactor(0).setVisible(true);
       ...
       this.keyNum = this.add.text(560, 23, window.key, {font: '50px Futura PT Medium', fill: '#ffffff'}).setScrollFactor(0);

class level_04_game extends Phaser.Scene {
    ...
    this.anims.create({
      ...
      this.seed1=this.physics.add.sprite(seed1.x,seed1.y,"gsamplingIMG");
      this.seed2=this.physics.add.sprite(seed2.x,seed2.y,"gsamplingIMG");
      this.seed3=this.physics.add.sprite(seed3.x,seed3.y,"gsamplingIMG");
      this.seed4=this.physics.add.sprite(seed4.x,seed4.y,"gsamplingIMG");
      this.seed5=this.physics.add.sprite(seed5.x,seed5.y,"gsamplingIMG");
      this.seed6=this.physics.add.sprite(seed6.x,seed6.y,"gsamplingIMG");
      this.seed7=this.physics.add.sprite(seed7.x,seed7.y,"gsamplingIMG");
      this.seed8=this.physics.add.sprite(seed8.x,seed8.y,"gsamplingIMG");
  ...
  this.tweens.add({
   ...
   this.cameras.main.setBounds(0, 0, this.level_04_game.widthInPixels, this.level_04_game.heightInPixels);
    ...
    this.physics.add.overlap(this.player, [this.seed1, this.seed2,this.seed3, this.seed4,this.seed5, this.seed6,this.seed7,this.seed8], globalCollectSeeds, null, this);
    this.physics.add.overlap(this.bullet, [this.enemy1, this.enemy2,this.enemy3, this.enemy4,this.enemy5, this.enemy6,this.enemy7, this.enemy8,this.enemy9], globalKillEnemies, null, this);
